...
import openai
import glob
api_key = "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"
project_name="hack-team-datadivers-392719"
bucket_name="hackathon-datadivers"
...
def createIndex(request):
    try:
        ...
        # def lang model
        llm = opena(temperature=0, model_name="text-ada-001", max_tokens=tokens, openai_api_key=api_key)
